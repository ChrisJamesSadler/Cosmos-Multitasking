    ...
    public class CPUUpdateIDTAsm : AssemblerMethod
    {
        ...
        public override void AssembleNew(Assembler.Assembler aAssembler, object aMethodInfo)
        {
            ...
            for (int j = 0; j < 256; j++)
            {
                ...
                XS.Set("static_field__Cosmos_Core_INTs_old_esp", XSRegisters.EAX, destinationIsIndirect: true);
                ...
                XS.Set(XSRegisters.EAX, "static_field__Cosmos_Core_INTs_old_esp", sourceIsIndirect: true);
