...
namespace Cosmos.HAL
{
  public static class Global
  {
    ...
    public static bool SchedulerEnabled
    {
      get
      {
        return Scheduler.usingMultitasking;
      }
      set
      {
        Scheduler.usingMultitasking = value;
      }
    }

    public static void InitMultitasking()
    {
      Scheduler.Init();
      SchedulerEnabled = true;
    }

    public static void CreateThread(uint entry)
    {
      Scheduler.CreateNewThread(entry);
    }

    public static void AddThread(Scheduler.ThreadData data)
    {
      Scheduler.AddThread(data);
    }

    public static void RemoveThread(Scheduler.ThreadData data)
    {
      Scheduler.RemoveThread(data);
    }
  }
}
